	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
			...
			.authorizeRequests()
				...
				.antMatchers("/api/log/getlog").hasAnyRole("ADMIN", "USER", "ANON")
			...
			.headers()
				...
				//.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Origin", "https://nighthawkcoders.github.io", "http://localhost:4002"))
